...
namespace SAM.API
{
    public static class Steam
    {
        ...
        {
            // Primeira tentativa: chave padrão 64-bit
            ...
            // Se não encontrou, tenta a chave WOW6432Node (32-bit em sistema 64-bit)
            ...
            // Retorna a string (ou vazia se não encontrou)
        ...
        public static bool Load()
        {
            ...
            Console.WriteLine(Environment.Is64BitProcess ? "x64 process" : "x86 process");
